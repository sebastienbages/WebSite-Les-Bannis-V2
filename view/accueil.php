...
<div id="content" class="flex">
    ...
    <aside id="aside_left" class="center">
        ...
        <br>
        <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=HWR8KYMBEAMNE&source=url" target="_blank"><img id="paypal" src="../img/don.png" alt="faire un don avec paypal"></a>
